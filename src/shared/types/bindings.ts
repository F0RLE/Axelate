...
export const commands = {
	...
	launchModule: (moduleId: string) => typedError<LaunchResponse, AppError>(__TAURI_INVOKE("launch_module", { moduleId })),
	...
	sendChatMessage: (request: ChatRequest) => typedError<ChatResponse, AppError>(__TAURI_INVOKE("send_chat_message", { request })),
