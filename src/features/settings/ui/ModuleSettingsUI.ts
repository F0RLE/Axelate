...
import type { ModuleSettingsSpecializedRenderer } from './ModuleSettingsSpecializedRenderer';
...
export class ModuleSettingsUI {
    ...
    private _specializedRenderer: ModuleSettingsSpecializedRenderer | null = null;
    ...
    public async openModuleSettings(app: IApp): Promise<void> {
        await this._openModuleSettingsHelper(app);
    }
    ...
    private _getSpecializedRenderer(): ModuleSettingsSpecializedRenderer {
        this._specializedRenderer ??= this._controllerFactory.createSpecializedRenderer();

        return this._specializedRenderer;
    }
