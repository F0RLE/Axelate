...
use super::github_release_targets::{
    hardware_for_target, recommended_release_target, release_assets_match_target,
};
...
mod tests {
    ...
    use crate::domain::modules::github_release_targets::{
        is_cpu_asset_name, is_gpu_asset_name, is_gpu_asset_name_lower,
    };
