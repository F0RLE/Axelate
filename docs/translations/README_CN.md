<div align="center">
  ...
  <p>
    ...
    &nbsp;
    <a href="README_RU.md"><img src="https://img.shields.io/badge/Russian-31303a?style=for-the-badge&logo=google-translate&logoColor=white" height="30" alt="Russian"/></a>
    &nbsp;
...
| 🛡️ 硬件绑定安全 | ⚡ 原生性能 | 🧩 隔离模块 |
| :---: | :---: | :---: |
| 您的数据使用 **AES-256-GCM** 密钥加密，密钥直接源自您的物理主板序列号。从设计上防止盗窃。 | 由混合 **Rust 内核** + **V8 Shell** 驱动。零延迟、瞬间启动，资源占用极低。 | 在严格隔离的环境中运行编码代理、数据分析师和创意工具。杜绝交叉污染。 |
...
[![Developer Cookbook](https://img.shields.io/badge/📖_开发者手册-阅读-31303a?style=flat-square)](../../docs/en/development.md)
[![Architecture Spec](https://img.shields.io/badge/🏗️_架构规范-深入研究-31303a?style=flat-square)](../../docs/en/architecture.md)
[![Contributing](https://img.shields.io/badge/🤝_贡献指南-阅读-31303a?style=flat-square)](../../CONTRIBUTING.md)
...
<br>
  ...
  <p>
    ...
    &nbsp;
    <a href="../../README.md"><img src="https://img.shields.io/badge/文档-31303a?style=for-the-badge&logo=gitbook&logoColor=white" height="30" alt="Docs"/></a>
  </p>
  <br />
</div>
